          ...
          {cards.map((card, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col items-center justify-between p-10 sm:p-12 h-[380px] bg-brand-surface-container/10 hover:bg-brand-surface-container/25 border-r border-b border-brand-border/30 overflow-hidden transition-all duration-500"
              >
                {/* Hover Gradient */}
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_100%_100%_at_50%_0%,rgba(255,255,255,0.1)_0%,transparent_60%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
                
                {/* Top: Icon + Title */}
                <div className="flex flex-col items-center gap-3 relative z-10 pt-2 transform group-hover:-translate-y-2 transition-transform duration-500">
                  <Icon className="w-8 h-8 text-white mb-1 transition-transform duration-500 group-hover:scale-110" />
                ...
                <div className="flex flex-col items-center text-center relative z-10 w-full h-[140px] justify-end">
                  <div className="transform group-hover:-translate-y-8 transition-transform duration-500 flex flex-col items-center">
                    <span className="text-brand-text-muted text-xs font-semibold uppercase tracking-wider mb-4 opacity-80 transition-opacity duration-500 group-hover:opacity-100">
                  ...
                  {/* Read more link */}
                  <div className="absolute bottom-0 flex items-center gap-1 text-brand-secondary text-sm font-medium cursor-pointer opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500 pointer-events-none group-hover:pointer-events-auto">
